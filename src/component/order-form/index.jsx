...
import Cart from '../dialog/cart-modal/cart';
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex items-start gap-8">
          ...
          <div className="w-1/3 border-gray border-2 py-4 ">
            ...
            <div className="mt-2 border-t-2 border-b-2 border-gray px-4">
              {cartItems.map((el) => (
                <Cart
                  key={el.id}
                  data={el}
            ...
            <button
              className="text-lg flex gap-2 bg-primary px-8 py-2 text-white"
              type="submit">
              {loading ? <Spinner /> : ''}
              Submit
            </button>
